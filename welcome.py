...
class Welcome:
    ...
    def choose_user(self):
        ...
        # patient
        patient = Button(frame, text="Patient", bd=3, relief=RIDGE, bg='#050542', fg='#f6f0f0', cursor='hand2',
                         activebackground='#050542', activeforeground='#f6f0f0', command=lambda: self.login(1))
        patient.place(x=92, y=260, width=160, height=30)
        patient.configure(font=("Times New Roman", 10, "bold"))
